...
const translations = {
  ...
  uk: {
    ...
    "tr-order-step3": "Ми підбираєм запчастини для вас:",
        ...
        "tr-brend-title": "В наявності запчастини до корейських та японських марок:",
...
const flagImg = languageBtn.querySelector('.language-flag');

// Текущий язык (по умолчанию берем из html lang атрибута)
...
function translatePage(lang) {
  ...
  languageBtn.innerHTML = `<img src="${selectedFlag}" class="language-flag" alt="${lang}"> ${selectedText} ▼`;
...
// Инициализация - проверяем сохраненный язык или браузерный
